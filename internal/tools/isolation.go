...
const sandboxHelperArgument = "__axiom_sandbox_exec"
...
// IsolationSupported reports whether this host can enforce Axiom's filesystem
...
// Axiom executable. The path must not be replaceable from a writable workspace
...
// Axiom's restricted exec helper. main calls this before initializing Wails.
